...
Every Amen-out shape priced against Matthew, run **2026-08-12**. Column meanings: `Eval Definitions`, `Delta w.md`, `Bracket value.md`. Roster and pick values: `Matthew.team.md`, `evals/teams/my-team/Ours.team.md`.
